...
unsafe fn execute_f32_x64_block_nofma_hyperplane(
    ...
    let div_by_2 = _mm256_set1_ps(2.0);
    ...
    let mean1 = _mm256_div_ps(sum1, div_by_2);
    let mean2 = _mm256_div_ps(sum2, div_by_2);
    let mean3 = _mm256_div_ps(sum3, div_by_2);
    let mean4 = _mm256_div_ps(sum4, div_by_2);
    let mean5 = _mm256_div_ps(sum5, div_by_2);
    let mean6 = _mm256_div_ps(sum6, div_by_2);
    let mean7 = _mm256_div_ps(sum7, div_by_2);
    let mean8 = _mm256_div_ps(sum8, div_by_2);
